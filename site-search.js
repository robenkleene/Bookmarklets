...
// Takes the last term of a Google search and makes a Google site search out of it, for example: "bookmarklet news.ycombinator" becomes "bookmarklet site:news.ycombinator.com". Basically allows a shorthand for creating site searches.

// Usage:
// 1. Construct a search in Google and perform it, e.g., search for "bookmarklet news.ycombinator". (You have to actually hit the search button, or otherwise perform the search, before triggering the bookmarklet.)
...
// It's sort of smart about how it constructs a search. For example:
